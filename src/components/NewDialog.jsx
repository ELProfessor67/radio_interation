...
export default function Dialog({open,onClose,children,seletdSongs,save,selectAll,name,setName,search}){
	return(
		<div className={`fixed top-0 left-0 z-10 right-0 bottom-0 pointer-events-none h-screen bg-black/5 ${open ? '': 'hidden'}`}>
			<div className="max-w-[20rem] pointer-events-auto absolute bottom-[13rem]  z-50 right-[3rem] min-h-[25rem] mx-auto mt-32 bg-white shadow-md p-4 rounded-md flex flex-col">
